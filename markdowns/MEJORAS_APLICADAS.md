...
- [x] Toggle de tema funciona (Teacher)
...
- [x] Modo oscuro se ve bien (Teacher)
- [x] Modo claro se ve bien (Teacher)
...
└── TeacherDashboardLayout.jsx ✅ (Nuevo layout)

frontend/src/pages/
└── TeacherDashboard.jsx ✅ (Completamente reescrito)
```
